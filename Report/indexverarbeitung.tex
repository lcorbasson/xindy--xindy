...
entwickelt wurde. Wir verwenden dazu formale Beschreibungen und eine
pascal-ähnliche, algorithmische Notation.\footnote{Diese Algorithmen
  sollen das grundsätzliche Verfahren aufzeigen und sind in der
  tatsächlichen Implementierung teilweise anders gelöst.}
