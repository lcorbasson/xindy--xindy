...
eigenen Überlegungen kommen wir nun zur Beschreibung des Indexmodells.
...
\begin{Def}
  Ein \demph{Index} \textit{i} ist eine Liste von Indexeinträgen.
...
Regeln auf"|findbar.  Wir haben uns hier bewußt auf die potentiellen
...
\item In Textsystemen werden Formatierungsanweisungen üblicherweise
  ...
  wie Zeichensatz oder Schriftgröße zu verändern. Wir sollten also in
...
\item Es ist vor allem bei Stichwörtern notwendig, ein
  ...
  verwendet, um dem Leser eine leichtere Orientierung zu ermöglichen.
...
\item Wir ordnen jedem Knoten die Eigenschaft \emph{aktiv} oder
  ...
  überläßt die Entscheidung über seine Einreihung der
...
geleert wird und die Anweisungen in den Ausgabestrom eingefügt werden.
...
die $l_i$ Stichwortgruppen der üblichen Form sind. Ein Markup besteht
in der einfachsten Form aus einem Paar von Strings, welche die
entsprechenden Formatierungs-Umgebungen einleiten und abschließen.
