...
#define SELECT_WIDTH_T size_t
#define SELECT_SET_T int
#define SELECT_CONST const
#define HAVE_SETITIMER 1
#define SETITIMER_CONST const
#define LOCALTIME_CONST const
#define HAVE_GETTIMEOFDAY 1
#define GETTIMEOFDAY_TIMEZONE_T struct timezone *
#define HAVE_FTIME 1
...
#define CODE_ADDRESS_RANGE 0x40000000UL
#define MALLOC_ADDRESS_RANGE 0x40000000UL
#define SHLIB_ADDRESS_RANGE 0x40000000UL
#define HAVE_MMAP 1
...
#define SHMGET_SIZE_T size_t
#define RETSHMATTYPE void*
#define SHMAT_CONST const
...
#define typecode(expr)  ((tint)(as_oint(expr) >> 24UL) & 0x3FUL)
...
typedef uint16 cint;
#define int_char(int_from_int_char)  type_data_object(15,(aint)(cint)(int_from_int_char))
...
#define fixnum(x)  type_data_object(16,x)
...
#define pointable(obj)  ((void*)((aint)as_oint(obj) & 0xC0FFFFFFUL))
#define TheBignum(obj)  ((Bignum)(((void*)(aint)pointable(obj))))
#define eq(obj1,obj2)  ((obj1) == (obj2))
#define nullp(obj)  (eq(obj,NIL))
#define posfixnump(obj)  (typecode(obj) == 16)
#define positivep(obj)  (!wbit_test(as_oint(obj),24))
#define uint8_p(obj)  ((as_oint(obj) & ~0xFFUL) == 0x10000000UL)
#define sint8_p(obj)  (((as_oint(obj) ^ (positivep(obj) ? 0 : 0x1FFFFFFUL)) & ~0x7FUL) == 0x10000000UL)
#define uint16_p(obj)  ((as_oint(obj) & ~0xFFFFUL) == 0x10000000UL)
#define sint16_p(obj)  (((as_oint(obj) ^ (positivep(obj) ? 0 : 0x1FFFFFFUL)) & ~0x7FFFUL) == 0x10000000UL)
#define uint32_p(obj)  ((typecode(obj)==16) || ((typecode(obj)==20) && (TheBignum(obj)->length <= 2UL) && ((TheBignum(obj)->length < 2UL) || (TheBignum(obj)->data[0] < (uintD)bit(0UL)) )))
#define sint32_p(obj)  (((typecode(obj) & ~1) == 16) || (((typecode(obj) & ~1) == 20) && (TheBignum(obj)->length <= 1UL) && ((TheBignum(obj)->length < 1UL) || ((TheBignum(obj)->data[0] ^ (positivep(obj) ? (uintD)0 : ~(uintD)0)) < (uintD)bit(31UL)) )))
#define uint64_p(obj)  ((typecode(obj)==16) || ((typecode(obj)==20) && (TheBignum(obj)->length <= 3UL) && ((TheBignum(obj)->length < 3UL) || (TheBignum(obj)->data[0] < (uintD)bit(0UL)) )))
#define sint64_p(obj)  (((typecode(obj) & ~1) == 16) || (((typecode(obj) & ~1) == 20) && (TheBignum(obj)->length <= 2UL) && ((TheBignum(obj)->length < 2UL) || ((TheBignum(obj)->data[0] ^ (positivep(obj) ? (uintD)0 : ~(uintD)0)) < (uintD)bit(31UL)) )))
extern object* STACK;
#define begin_call()
#define end_call()
...
#define S_help_(name)  (type_constpointer_object(8,&symbol_tab.name))
#define NIL  S(nil)
#define T    S(t)
...
#ifndef IN_MODULE_CC
register uintC mv_count __asm__("%r11");
#endif
extern object mv_space [127];
#ifndef IN_MODULE_CC
  register object value1 __asm__("%r12");
#endif
#ifndef IN_MODULE_CC
  register object subr_self __asm__("%r13");
#endif
