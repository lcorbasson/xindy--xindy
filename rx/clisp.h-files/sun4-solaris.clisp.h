...
#define bit(n)  (1L<<(n))
#define bit_test(x,n)  ((((n)<12) && ((x) & bit(n))) || (((n)>=12) && ((sint32)((uint32)(x) << (31-(n))) < 0)))
...
#define typecode(expr)  ((as_oint(expr) << 0) >> 24)
...
typedef uint16 cint;
#define int_char(int_from_int_char)  type_data_object(33,(aint)(cint)(int_from_int_char))
...
#define posfixnum_to_L(obj)  ((uintL)((as_oint(obj) << 8) >> 8))
...
#define pointable(obj)  ((void*)((aint)as_oint(obj) & 0x1FFFFFFFUL))
...
#define symbol_tab_addr ((struct symbol_tab_ *)type_zero_oint(14))
...
#ifndef IN_MODULE_CC
register uintC mv_count __asm__("%g6");
#endif
