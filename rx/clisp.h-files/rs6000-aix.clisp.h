...
#define SHLIB_ADDRESS_RANGE 0x20000000UL
...
#define typecode(expr)  ((tint)(as_oint(expr) >> 24UL) & 0xDFUL)
...
#define pointable(obj)  ((void*)((aint)as_oint(obj) & 0x20FFFFFFUL))
...
#define S_help_(name)  (type_constpointer_object(64,&symbol_tab.name))
#define NIL  S(nil)
#define T    S(t)
